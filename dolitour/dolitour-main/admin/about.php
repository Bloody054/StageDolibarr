...
$versions = array(
	array('version' => '1.0.0', 'date' => '07/01/2021', 'updates' => $langs->trans('DoliTourFirstVersion')),
);
/*
 * View
 */
...
llxHeader('', $langs->trans('DoliTourAbout'));

// Subheader
$linkback = '<a href="' . DOL_URL_ROOT . '/admin/modules.php">'. $langs->trans("BackToModuleList") . '</a>';
print load_fiche_titre($langs->trans('DoliTourAbout'), $linkback);
...
echo $langs->trans("DoliTourAboutPage");

echo '<br />';

print '<h2>'.$langs->trans("About").'</h2>';
print $langs->trans("DoliTourAboutDescLong");
